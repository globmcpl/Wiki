...
Aby wyzwać gracza na pojedynek, użyj komendy **/duel (nick)**. Gracz zostanie poinformowany o propozycji walki i będzie miał możliwość zaakceptować lub odrzucić pojedynek. W przypadku zaakceptowania pojedynku zostaniecie przeteleportowani na arenę i rozpocznie się pojedynek.
